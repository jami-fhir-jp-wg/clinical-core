...
* code.coding[jlac10wUnmethod].system = $JP_CLINS_ObsLabResult_JLAC10Unmethod_CS (exactly)   // MEDIS JLAC10の測定法部分を998(測定法問わず)にしたコード
* code.coding[jlac10wUnmethod].code from $JP_CLINS_ObsLabResult_JLAC10Unmethod_InfectionRelated_VS  // MEDIS JLAC10　から感染症関係コードリスト(測定法なし)
