...
cd ..   
java -Xmx12G -Djava.awt.headless=true -jar ../work/validator_cli.jar validateLog/json/*.json -version 4.0.1  -language ja  -ig jp-core.r4#1.1.2-clins -ig jpfhir-terminology.r4#1.3 -ig fsh-generated-backup/jp-eCSCLINS-package-diff.tgz -locale ja-JP -tx n/a  -want-invariants-in-messages  -no-extensible-binding-warnings  -display-issues-are-warnings   -level warnings -best-practice ignore >validateLog/$1_$2.log
#ls -l validateLog
