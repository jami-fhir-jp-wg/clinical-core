...
mkdir -p ~/.fhir/packages/'jpfhir-terminology.r4#1.3.0'
gtar xf packages_snapshot/jpfhir-terminologyr4-current.tgz  -C ~/.fhir/packages/'jpfhir-terminology.r4#1.3.0'
