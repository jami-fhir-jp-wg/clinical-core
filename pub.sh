...
mkdir -p ~/.fhir/packages/'jpfhir-terminology.r4#1.2.0'
gtar xf packages_snapshot/jpfhir-terminology.r4-1.2.0.tgz  -C ~/.fhir/packages/'jpfhir-terminology.r4#1.2.0'
