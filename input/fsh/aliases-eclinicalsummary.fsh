...
Alias: $JP_Hospital_PatientID = http://jpfhir.jp/fhir/eCS/Idsystem/JP_Hospital_PatientID
Alias: $JP_Insurance_memberID = http://jpfhir.jp/fhir/clins/Idsystem/JP_Insurance_memberID
Alias: $JP_PublicPayer_memberID = http://jpfhir.jp/fhir/clins/Idsystem/JP_Insurance_memberID    //生活保護受給者ID識別子

Alias: $JP_Hospital_PatientID_Pseudonymized = http://jpfhir.jp/fhir/eCS/Idsystem/JP_Hospital_PatientID_Pseudonymized
...
Alias: $JP_ehrshrs_indication_lts_VS = http://jpfhir.jp/fhir/clins/ValueSet/JP_ehrshrs_lts_indication
Alias: $JP_ehrshrs_indication_forCondition_VS = http://jpfhir.jp/fhir/clins/ValueSet/JP_ehrshrs_forCondition_indication
