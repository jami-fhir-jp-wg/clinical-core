...
* include codes from system $JP_CLINS_CodeSystem_JLAC10_CoreLabo_CS    //共有項目JLACコード
* include codes from system $JP_CLINS_CodeSystem_JLAC10_InfectionLabo_CS   //感染症検査項目コード
