...
Severity: #error
Expression: "name.extension.where(url='http://hl7.org/fhir/StructureDefinition/iso21090-EN-representation' and valueCode='IDE').exists() or name.extension.where(url='http://hl7.org/fhir/StructureDefinition/iso21090-EN-representation' and valueCode='SYL').exists()"
