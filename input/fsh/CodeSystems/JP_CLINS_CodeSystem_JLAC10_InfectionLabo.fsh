...
* ^property[+].code = #unit
* ^property[=].uri = "http://jpfhir.jp/fhir/eCS/CodeSystem/laboItem_unitProperty2"
* ^property[=].type = #string
* ^property[+].code = #specimen
* ^property[=].uri = "http://jpfhir.jp/fhir/eCS/CodeSystem/laboItem_specimenProperty2"
* ^property[=].type = #string
* ^property[+].code = #method
* ^property[=].uri = "http://jpfhir.jp/fhir/eCS/CodeSystem/laboItem_methodProperty2"
* ^property[=].type = #string
* ^property[+].code = #fullNumberOfDigits
* ^property[=].uri = "http://jpfhir.jp/fhir/eCS/CodeSystem/laboItem_ndigitsProperty2"
* ^property[=].type = #integer
* ^property[+].code = #numberOfDecimalDigits
* ^property[=].uri = "http://jpfhir.jp/fhir/eCS/CodeSystem/laboItem_ddigitsProperty2"
* ^property[=].type = #integer
* ^property[+].code = #oidOfValueSet
* ^property[=].uri = "http://jpfhir.jp/fhir/eCS/CodeSystem/laboItem_oidVSProperty2"
* ^property[=].type = #string
* #STS-QLRESULT
...
* #TP-POS-COI
  ...
  * #5E075000002206233  "梅毒TP抗体(定量、陽性コントロール比)"
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "ラテックス凝集比濁法"
  * #5E075000002302333  "梅毒TP抗体(定量、陽性コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "梅毒TP抗体(定量、陽性コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
...
* #Hbs-AG-OD 
  ...
  * #5F016141002299904  "HBs抗原(吸光度)"
    ...
    * ^property[=].valueString = "その他"
* #HBs-AG-COI
  * #5F016141002302331  "HBs抗原(コントロール比)"
    * ^designation.language = #ja
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "エンザイムイムノアッセイ(EIA)"
  * #5F016141002202331  "HBs抗原(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HBs抗原(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "エンザイムイムノアッセイ(EIA)"
  * #5F016141002305231  "HBs抗原(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HBs抗原(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F016141002205231  "HBs抗原(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HBs抗原(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F016141002399931  "HBs抗原(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HBs抗原(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "その他"
  * #5F016141002299931  "HBs抗原(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HBs抗原(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
...
* #HCV-AB-COI
  ...
  * #5F360151602206331  "HCV抗体(コントロール比)"
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "免疫比朧法(ネフェロメトリー)"
  * #5F360151601906331  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "全血(添加物入り)"
  ...
  * #5F360151202302331  "HCV抗体(コントロール比)"
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "エンザイムイムノアッセイ(EIA)"
  * #5F360151202202331  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "エンザイムイムノアッセイ(EIA)"
  * #5F360148802305331  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(ECLIA)"
  * #5F360148802205331  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(ECLIA)"
  * #5F360152102305331  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(ECLIA)"
  * #5F360152102205331  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(ECLIA)"
  * #5F360151702305231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360151702205231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360148702305231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360148702205231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360151002305231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360151002205231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360151302305231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360151302205231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360148802305231  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F360148802399931  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
  ...
  * #5F360151302299931  "HCV抗体(コントロール比)"
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "その他"
  * #5F360151601900031  "HCV抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HCV抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "全血(添加物入り)"
...
* #HIV-1P2-AB-P24-RESULT
  ...
  * #5F560155001999953  "HIV-1+2抗体・p24抗原(定性)"
    ...
    * ^property[=].valueString = "その他"
* #HIV-1P2-AB-P24-COI
  * #5F560155002305331  "HIV-1+2抗体・p24抗原(コントロール比)"
    * ^designation.language = #ja
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(ECLIA)"
  * #5F560155002205331  "HIV-1+2抗体・p24抗原(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体・p24抗原(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
  ...
  * #5F560155002205231  "HIV-1+2抗体・p24抗原(コントロール比)"
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F560155002399931  "HIV-1+2抗体・p24抗原(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体・p24抗原(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "その他"
  * #5F560155002299931  "HIV-1+2抗体・p24抗原(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体・p24抗原(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
...
* #HIV-2-AB-RESULT
  ...
  * #5F550143002299911  "HIV-2抗体(定性)"
    ...
    * ^property[=].valueString = "その他"
* #HIV-1P2-AB-COI
  * #5F560143002305131  "HIV-1+2抗体(コントロール比)"
    * ^designation.language = #ja
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLIA)"
  * #5F560143002205131  "HIV-1+2抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
  ...
  * #5F560143002205231  "HIV-1+2抗体(コントロール比)"
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "化学･生物発光イムノアッセイ(CLEIA)"
  * #5F560143002306331  "HIV-1+2抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血清"
    * ^property[+].code = #method
    * ^property[=].valueString = "免疫比朧法(ネフェロメトリー)"
  * #5F560143002206331  "HIV-1+2抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "免疫比朧法(ネフェロメトリー)"
  * #5F560143001906331  "HIV-1+2抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "全血(添加物入り)"
  ...
  * #5F560143002399931  "HIV-1+2抗体(コントロール比)"
    ...
    * ^property[+].code = #method
    * ^property[=].valueString = "その他"
  * #5F560143002299931  "HIV-1+2抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "血漿"
    * ^property[+].code = #method
    * ^property[=].valueString = "その他"
  * #5F560143001999931  "HIV-1+2抗体(コントロール比)"
    * ^designation.language = #ja
    * ^designation.value = "HIV-1+2抗体(コントロール比)"
    * ^property[+].code = #specimen
    * ^property[=].valueString = "全血(添加物入り)"
