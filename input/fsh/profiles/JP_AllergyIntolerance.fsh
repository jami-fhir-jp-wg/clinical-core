...
* reaction.substance ^short = "有害反応の原因と考えられる特定の物質または医薬品"
* reaction.substance ^definition = "有害反応の原因と考えられる物質（または医薬品）。\r\n\r\n注：特定の有害反応を誘発する物質は、原因として特定された物質と異なっていてもよいが、整合がとれていなければならない。たとえば、より具体的な物質（ブランド薬など）や、特定された物質を含む複合製品の場合がある。\r\nAllergyIntolerance.codeのみを処理し、AllergyIntolerance.reaction.substanceを無視しても、臨床的に安全でなければならない。\r\n受信システムがAllergyIntolerance.reaction.substanceがAllergyIntolerance.codeのセマンティックスコープ内に（前者が後者の意味的な下位概念にあること）を確認できない場合、受信システムはAllergyIntolerance.reaction.substanceを無視する必要がある。"
* reaction.manifestation ^short = "この有害反応に関連する症状や兆候"
* reaction.manifestation ^definition = "この有害反応に関連する症状や兆候。"
* reaction.description ^short = "この有害反応に関する全般的な記述"
* reaction.description ^definition = "必要であれば症状兆候の詳細も含めた、有害反応全体に関するテキストによる記述。"
* reaction.onset ^short = "この有害反応がみられた日時"
* reaction.onset ^definition = "この有害反応の開始の日付もしくは日時の記録。"
* reaction.severity ^short = "mild | moderate | severe (of event as a whole) （軽度 | 中度 | 重度）"
* reaction.severity ^definition = "有害反応の重症度の全体としての臨床的な評価で、潜在的には複数の異なる症状兆候を考慮して決める。"
* reaction.exposureRoute ^short = "患者がこの物質にどのように暴露したか"
* reaction.exposureRoute ^definition = "患者がどのような経路でこの物質に暴露したかの同定。"
* reaction.note ^short = "他のフィールド要素では記述できない追加テキスト"
* reaction.note ^definition = "他のフィールド要素では記述できない、有害反応に関する追加テキスト。"
