...
* code.coding[coreLaboJLAC10/{itemID}].version 0..1 MS
...
* code.coding[coreLaboJLAC11/{itemID}].version 0..1 MS
...
* code.coding[infectionLaboJLAC10/{itemID}].version 0..1 MS
...
* code.coding[infectionLaboJLAC11/{itemID}].version 0..1 MS
