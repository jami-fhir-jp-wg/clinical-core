// -----------------------------------------
//JP_eCS_DiagnosticType
// -----------------------------------------
Extension: JP_eCS_DiagnosticType
Id: jp-ecs-disgnosticType
Title: "JP eCS Disgnostic Type Extension"
Description: "傷病名情報に主たる診療対象病名か、あるいはそれ以外の情報をタイプかを付与する拡張"
* ^url = http://jpfhir.jp/fhir/eCS/Extension/StructureDefinition/JP_eCS_DiagnosticType
* ^status = #active
* ^date = "2024-06-17"
...
* valueCodeableConsept from http://hl7.org/fhir/ValueSet/ex-diagnosistype
* valueCodeableConsept.system = "http://terminology.hl7.org/CodeSystem/ex-diagnosistype" (exactly)
