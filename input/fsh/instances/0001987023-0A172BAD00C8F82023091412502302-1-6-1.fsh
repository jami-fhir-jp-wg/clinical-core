Instance: 0009997023-0A172BAD00C8F82023091412502302-1-6-1
...
* category.text = "院外処方"
* medicationCodeableConcept.coding[0] = urn:oid:1.2.392.200119.4.403.1#124044301 "タケキャブ錠１０ｍｇ"
* medicationCodeableConcept.coding[+] = $Icode#I1350000 "タケキャブ錠１０ｍｇ"
* medicationCodeableConcept.text = "タケキャブ錠１０ｍｇ"
...
* dosageInstruction.timing.code.text = "1日1回 昼食後"
