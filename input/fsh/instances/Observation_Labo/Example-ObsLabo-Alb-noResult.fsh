Instance: Example-JP-Obs-LabResult-eCS-Alb-noResult
InstanceOf: JP_Observation_LabResult_eCS
Usage: #example
Description: "Observationリソース（検体検査結果）結果がない（検体凝固）が、基準値情報はあるケース。"
* note.text = "Observationリソース（検体検査結果）アルブミン　結果がない（検体凝固）が、基準値情報はあるケース。"

* meta.lastUpdated = "2025-01-11T14:11:13.000+09:00"
