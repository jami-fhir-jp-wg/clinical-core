...
* entry[=].resource = Example-JP-Practitioner-eCS-ReferralTo01Inline
...
* entry[=].resource = Example-JP-Encounter-eCS-purpose-Referral01Inline

* entry[+].fullUrl = "urn:uuid:6a31db8e-109d-4349-b0cf-095131c3307a"
* entry[=].resource = Example-JP-Condition-eCS-cc1-Referral01Inline

* entry[+].fullUrl = "urn:uuid:a9358f3e-c743-4998-aa89-1be54c31b432"
* entry[=].resource = Example-JP-Condition-eCS-cc2-Referral01Inline

* entry[+].fullUrl = "urn:uuid:5eab50b2-6741-467c-a2fd-a4adab1f835f"
* entry[=].resource = Example-JP-Condition-eCS-ABDPAINInline
...
* entry[=].resource = Example-JP-DocRef-eCS-clinical-ccourse-Referral01Inline
