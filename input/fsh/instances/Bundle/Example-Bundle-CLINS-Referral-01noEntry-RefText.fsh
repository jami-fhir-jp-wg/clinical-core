...
Instance: Bundle-CLINS-Referral-NoEntry-Example-01-RefText
InstanceOf: JP_Bundle_eReferral
Usage: #example

Description: "■ 診療情報提供書　Bundleリソース(CLINS送信用)　#02 必須のヘッダ情報以外はentry記述をせず、テキストだけを各セクションに記述し、臨床経過だけはDocumentReferenceにテキストを記述してentryで参照している例。"

* meta.lastUpdated = "2024-12-03T10:00:00+09:00"
