Instance: 0008363939-AC12821012A0552021070513070302-1-1-1
...
* category.text = "持参薬処方"
* medicationCodeableConcept.coding[0] = urn:oid:1.2.392.200119.4.403.1#107296901 "フェロミア錠５０ｍｇ"
* medicationCodeableConcept.coding[+] = $Icode#I1551620 "フェロミア錠５０ｍｇ"
* medicationCodeableConcept.text = "フェロミア錠５０ｍｇ"
...
* dosageInstruction.text = "1日2回 朝夕食後 １回 1錠  (１日  2錠) 10　日分"
* dosageInstruction.timing.event = "2021-07-05T12:00:00+09:00"
* dosageInstruction.timing.repeat.boundsDuration = 11 'd' "日"
...
* dispenseRequest.quantity = 20 urn:oid:1.2.392.100495.20.2.101#TAB "錠"
