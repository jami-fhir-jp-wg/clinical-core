...
* meta.profile[+] = "http://jpfhir.jp/fhir/eReferral/StructureDefinition/JP_Composition_eReferral|x.x.x-instance"
* meta.profile[+] = "http://jpfhir.jp/fhir/eReferral/StructureDefinition/JP_Composition_eReferral|x.x.x-instance"
* language = #ja
...
* section[referralToSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">紹介先医療機関名：東京第一テスト病院<br />内科<br />紹介先医師：野口 英世丸先生</div>"
...
* section[referralFromSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">東京都港区新橋１−２−３
...
* section[compositionSection].section[referralPurposeSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">腹痛精査お願いします。</div>"
...
* section[compositionSection].section[problemSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">2022-06-09 上腹部痛、2022-05 腰痛</div>"
...
* section[compositionSection].section[presentIllnessSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">２０２２年６月上旬から夜食後に時々上腹部痛があり、だんだんひどくなっている。他に目立った症状なし。</div>"
...
* section[compositionSection].section[pastIllnessSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">2018年　狭心症　２ヶ月治療で軽快。2019年　交通事故で左前腕骨折　３ヶ月ギプス固定。</div>"
...
* section[compositionSection].section[allergiesIIntoleranceSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">サバ、キーウイ（発症:2020-04-10  情報源：本人　記録：2024-07-10　記録者：看護師A）、ヨード禁（ポビドンヨード含嗽後に嘔吐と全身に発疹）</div>"
...
* section[compositionSection].section[familiyHistorySection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">母　胃がん</div>"
...
* section[compositionSection].section[admissionPhysicalStatusSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">腹部所見：上腹部圧痛あり、その他特に所見なし。</div>"
...
* section[compositionSection].section[infectiousDiseaseInformationSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\">特になし</div>"
...
* section[compositionSection].section[medicationSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\"> タケキャブ錠10mg1錠　１日2回　朝食後、就寝時<br />レバミピド錠100mg1錠　　１日3回毎食後</div>"
...
* section[remarksCommunicationSection].text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"　 xml:lang=\"ja\"> よろしくお願いします。</div>"
