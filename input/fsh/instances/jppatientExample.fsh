...
Instance: Example-JP-Patient-eCS-MAKINO
...
Instance: Example-JP-Patient-eCS-MAKINO-test
InstanceOf: JP_Patient_eCS
Usage: #example
  
Description: "Patientリソース　（患者情報）test"
...
* identifier[+].extension[0].url = "http://hl7.org/fhir/StructureDefinition/iso21090-nullFlavor"
* identifier[=].extension[=].valueCode = #NI
/*
* identifier[+].system = "urn:oid:1.2.392.100495.20.3.51.11318814790"
* identifier[=].value = "000999739"
* identifier[+].system = $JP_Insurance_memberID
...
* address.extension[0].url = "http://hl7.org/fhir/StructureDefinition/iso21090-nullFlavor"
* address.extension[=].valueCode = #NI
/*
* address.text = "高知県高知市五台山4200-6"
* address.postalCode = "781-8125"
* address.city = "高知市"
