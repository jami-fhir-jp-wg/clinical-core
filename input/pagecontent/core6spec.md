...
<img src="identifier.png" style="display: block; margin: auto;" width="100%"><br clear="all">

通常、１回のオーダや結果報告で、複数の処方薬、複数の検査結果項目が発生するので、その複数のリソースインスタンスを１回のBundleで送信することが通常行われる。
