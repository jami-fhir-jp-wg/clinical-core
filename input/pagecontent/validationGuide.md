...
- jpfhir-terminology.r4-x.y.z.tgz のx.y.zの部分は、使用する時点で公開されている最新のバージョン文字列（例えば2.2601.0など）に置き変えること。
  ...
  - jpfhir-terminology.r4　パッケージ
    ...
    - tgz形式 : [https://jpfhir.jp/fhir/core/terminology/jpfhir-terminology.r4-x.y.z.tgz](https://jpfhir.jp/fhir/core/terminology/jpfhir-terminology.r4-x.y.z.tgz)
 　 
  - jp-eCSCLINS.r4　パッケージ
      
  - tgz形式 : [https://jpfhir.jp/fhir/clins/pkghistory/jp-eCSCLINS.r4-1.x.x-temp@buildDateXXX-temp.tgz](https://jpfhir.jp/fhir/clins/pkghistory/jp-eCSCLINS.r4-1.x.x-temp@buildDateXXX-temp.tgz)
...
```  bash
 java -jar [prog]/validator_cli_6.1.8.jar \
    [targets]/*.json \
      ...
      -ig [pkgClins]/jpfhir-terminology.r4-x.y.z.tgz  \
      -ig [pkgClins]/jp-eCSCLINS.r4-1.x.x-temp@buildDateXXX-temp.tgz  
...
Loading
  ...
  Load pkgClins/jpfhir-terminology.r4-x.y.z.tgz - 175 resources (00:03.988)
  Load pkgClins/jp-eCSCLINS.r4-1.x.x-temp@buildDateXXX-temp.tgz - 148 resources (00:00.081)
