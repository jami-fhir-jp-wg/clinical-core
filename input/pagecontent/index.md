...
この形態では、複数のリソース・インスタンスのセットを一括して送信するために、複数のリソースインスタンスを格納したひとつのBundleリソースタイプのデータとして送信する仕様も本実装ガイドで定める。
...
<span style="color: blue; font-size: 150%;">6情報のリソースとBundleリソースの詳細は以下のページを参照ください。<br><A href="core6spec.html">
☞「6情報FHIR詳細仕様」</a></spam>
