...
### 電子カルテ情報共有サービス（３文書６情報作成・送信）のためのFHIR実装ガイド
 <span style="color: red; font-size: 120%;"><<注意：このIGは協議中の暫定的な内容が含まれます。リソースのProfileも暫定版です。内容は間違いや暫定情報を含むことがあります。お気づきの点は上部に記載のGoogleフォームからお知らせをお願いします。>></span>
  <span style="color: black; font-size: 120%;"><<本実装ガイドは、令和２年度厚⽣労働科学特別研究事業「診療情報提供書, 電⼦処⽅箋等の電⼦化医療⽂書の相互運⽤性確保のための標準規格の開発研究」、令和３−４年度同「次世代の医療情報の標準規格への改定等に関する研究」、それらに関連した後続の作業、および日本医療情報学会NeXERS課題研究会「FHIR日本実装検討WG」活動の協力によりとして作成されています。>></span>
<br>
