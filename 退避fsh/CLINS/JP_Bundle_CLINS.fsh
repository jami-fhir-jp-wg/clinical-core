...
Description: "CLINS 電子カルテ情報共有サービスへの５情報送信用 Bundleリソース プロファイル"
* ^url = $JP_Bundle_CLINS
* ^status = #active
* . ^short = "電子カルテ情報共有サービスへの５情報送信用 Bundleリソース"
* . ^definition = "電子カルテ情報共有サービスへの５情報送信用 Bundleリソース"
...
Bundle.identifier.value : 実装ガイド本文 ５情報送信仕様--Bundleリソースを識別するIdentifier要素-- に記載の[Bundle-ID]の仕様とする。"
...
* link ^definition = "このBundleが５情報リソース（4種類）のどれを格納するためのものかを、そのリソースのprofile　URLにより記述する。"
